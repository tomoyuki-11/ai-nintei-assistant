        ...
        <div className="w-full max-w-sm bg-gray-800 rounded-xl p-8 border border-gray-700">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <input
              ...
              required
              className="w-full rounded-lg bg-gray-700 border border-gray-600 px-3 py-2 text-sm text-white placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
            {loginError && <p className="text-sm text-red-400">{loginError}</p>}
            <button
              type="submit"
              className="w-full rounded-lg bg-blue-600 px-4 py-2.5 text-sm text-white font-medium hover:bg-blue-700 transition-colors"
            >
              ログイン
            </button>
          </form>
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
        ...
        {/* 新規施設フォーム */}
        {showCreate && (
          <div className="mb-6 rounded-xl border-2 border-blue-200 bg-white p-6 shadow-sm">
            ...
            <form onSubmit={handleCreate} className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 resize-y font-mono"
                />
              </div>
        ...
        {/* 発行済み情報パネル */}
        {issuedInfo && (
          <div className="mb-6 rounded-xl border-2 border-green-300 bg-green-50 p-6 shadow-sm">
            ...
            <p className="text-xs font-semibold text-red-600 bg-red-50 border border-red-200 rounded px-3 py-2 mb-4">
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="shrink-0 rounded-lg border border-gray-300 px-3 py-2 text-xs text-gray-600 hover:bg-white transition-colors"
                  >
                    コピー
                  </button>
                </div>
              ...
              >
                ...
                <div className="flex items-center justify-between px-5 py-4">
                  ...
                  <button
                    ...
                    className="shrink-0 ml-4 rounded-lg border border-gray-300 px-4 py-2 text-sm text-gray-600 hover:bg-gray-50 transition-colors"
                  >
                ...
                {detailId === org.id && (
                  <div className="border-t border-gray-100 bg-gray-50 px-5 py-4">
                    <div className="flex items-center gap-3 flex-wrap mb-3">
                      <span className={`rounded-full px-2 py-0.5 text-xs font-medium ${PLAN_COLORS[org.plan] ?? "bg-gray-100 text-gray-600"}`}>
                        {PLAN_LABELS[org.plan] ?? org.plan}
                      </span>
                      {!org.is_active && (
                        <span className="rounded-full px-2 py-0.5 text-xs font-medium bg-red-100 text-red-600">無効</span>
                      )}
                    ...
                    {deletingId === org.id ? (
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          ...
                          className="rounded px-2.5 py-1 text-xs border border-gray-300 text-gray-600 hover:bg-gray-50"
                        >いいえ</button>
                      </div>
                    ) : (
                      <div className="flex items-center gap-2">
                      ...
                      <ul className="space-y-1.5">
                        {staffMap[org.id].map((s) => (
                          <li key={s.id} className="flex items-center gap-3 text-xs">
                            <span className={`rounded-full px-2 py-0.5 font-medium ${s.role === 'admin' ? 'bg-purple-100 text-purple-700' : 'bg-gray-100 text-gray-600'}`}>
