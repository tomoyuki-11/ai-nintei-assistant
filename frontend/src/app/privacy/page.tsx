  ...
  return (
    <main className="min-h-screen bg-gray-50 px-4 py-10">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="space-y-8 text-sm text-gray-700 leading-relaxed">
          ...
          <section>
            ...
            <div className="mt-2 bg-gray-100 rounded-lg px-4 py-3 text-xs">
              <p>運営者：運営者</p>
              <p>サービスURL：https://app.ai-nintei-assistant.com/</p>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-1 mb-4 pl-2">
              ...
              <li>
                パスワード（bcrypt等により不可逆なハッシュ化処理を施した上で保管します。元のパスワードは保管しません）
              </li>
            </ul>
            ...
            <ul className="list-disc list-inside space-y-1 mb-4 pl-2">
              ...
              <li>
                Stripe社が発行する顧客ID・サブスクリプションID（クレジットカード番号等の決済情報は、本サービスのサーバーには一切保存しません）
              </li>
            </ul>
          ...
          <section>
            ...
            <p className="mb-2">
              録音した音声ファイルは、
              <strong>本サービスのサーバーには保存されません</strong>。
            </p>
            <p className="mb-2">
              音声データは文字起こし処理のためにOpenAI社のWhisper
              APIへ送信され、テキスト変換の完了後にサーバー上から消去されます。サーバーが音声データを保持するのは、文字起こし処理が完了するまでの一時的な間のみです。
            </p>
          ...
          <section>
            ...
            <div className="space-y-4">
              <div className="border border-gray-200 rounded-lg p-4">
                ...
                <p className="text-xs mb-1">
                  <span className="text-gray-500">目的：</span>Whisper
                  APIを用いた音声の文字起こし
                </p>
                <p className="text-xs">
              ...
              <div className="border border-gray-200 rounded-lg p-4">
                ...
                <p className="text-xs mb-1">
                  <span className="text-gray-500">送信するデータ：</span>
                  決済に必要な情報（Stripeの画面上で直接入力。クレジットカード情報は本サービスのサーバーを経由しません）
                </p>
                <p className="text-xs mb-1">
                  <span className="text-gray-500">目的：</span>
                  月額プランおよびクレジット購入の決済処理
                </p>
                <p className="text-xs">
                  <span className="text-gray-500">プライバシーポリシー：</span>
                  <a
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-1 pl-2">
              <li>
                データはAWS（Amazon Web Services）上のサーバーで管理しています
              </li>
              <li>通信はすべてHTTPS（SSL/TLS暗号化）で行われます</li>
              <li>
                パスワードはハッシュ化して保管し、元のパスワードは保持しません
              </li>
              <li>
                ログイン状態は認証トークン（JWT）としてお使いのデバイスのlocalStorageに保存されます
              </li>
              <li>
                Google Analyticsなどのアクセス解析ツールは使用していません
              </li>
          ...
          <section>
            ...
            <p className="mb-3">
              本サービスを通じて送信された音声データ・文字起こしテキスト・調査記録は、
              <strong>AIモデルの学習・訓練には使用されません</strong>。
            </p>
            <ul className="list-disc list-inside space-y-2 pl-2 mb-3">
              ...
              <li>
                ...
                APIの利用規約（Commercial
                Terms）において「顧客コンテンツをモデルの学習に使用しない」ことが明記されています。
              </li>
            </ul>
            <p className="text-xs text-gray-500">
              ※
        ...
        <p className="mt-10 text-xs text-gray-400 text-right">
          制定日：2026年7月13日
        </p>
      </div>
    </main>
