  ...
  return (
    <main className="min-h-screen bg-gray-50 flex flex-col items-center justify-center px-4">
      ...
      <div className="w-full max-w-sm space-y-4">
        ...
        <div className="relative flex items-center w-full rounded-xl border-2 border-gray-200 bg-gray-50 px-5 py-4 shadow-sm cursor-not-allowed gap-4 opacity-60">
          <div className="shrink-0 w-12 h-12 rounded-xl bg-gray-100 flex items-center justify-center">
            <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="3" y="8" width="18" height="13" rx="1.5" fill="#9CA3AF" opacity="0.3"/>
              <rect x="3" y="8" width="18" height="13" rx="1.5" stroke="#6B7280" strokeWidth="1.5"/>
              <path d="M8 21V13h8v8" stroke="#6B7280" strokeWidth="1.5" strokeLinejoin="round"/>
              <path d="M3 10L12 3l9 7" stroke="#6B7280" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
              <rect x="10" y="15" width="4" height="6" rx="0.5" fill="#6B7280" opacity="0.5"/>
              <rect x="6" y="13" width="2.5" height="2.5" rx="0.3" fill="#6B7280"/>
              <rect x="15.5" y="13" width="2.5" height="2.5" rx="0.3" fill="#6B7280"/>
            </svg>
          </div>
          <div className="text-left">
            <div className="flex items-center gap-2">
              <p className="text-base font-semibold text-gray-400">法人での使用</p>
              <span className="rounded-full bg-gray-200 px-2 py-0.5 text-xs font-medium text-gray-500">準備中</span>
            </div>
            <p className="text-xs text-gray-400 mt-0.5">現在準備中です。しばらくお待ちください。</p>
          </div>
        </div>
